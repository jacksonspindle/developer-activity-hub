...
export const CARD_CONFIGS: CardConfig[] = [
  { id: "productivity-score", defaultSpan: 3, minSpan: 2, maxSpan: 4, label: "Productivity Score" },
  { id: "hero-stats", defaultSpan: 1, minSpan: 1, maxSpan: 2, label: "Stats Overview" },
  ...
  { id: "streaks", defaultSpan: 1, minSpan: 1, maxSpan: 4, label: "Streaks & Achievements" },
